...
Полученный TOP-5 не рассматривается как окончательный рейтинг бирж. `Final Score` отражает результат только по показателям, включенным в количественную модель, и используется как отправная точка для дальнейшего анализа. Дополнительные характеристики площадок и особенности их работы учитываются отдельно в аналитической части. Поэтому итоговый аналитический вывод может отличаться от результатов количественного рейтинга.


### Аналитический вывод

Количественный рейтинг использовался как отправная точка для анализа, однако при формировании итогового TOP-5 дополнительно учитывались характеристики, которые не полностью отражаются в `Final Score`: положение площадки на рынке, широта торговых возможностей, прозрачность резервов, устойчивость инфраструктуры и дополнительные механизмы защиты пользовательских активов.
...
Поэтому первое место Binance не требует существенной корректировки после качественного анализа: количественные результаты подтверждаются общим положением площадки на рынке.

#### 2. OKX

OKX заняла третье место в количественном рейтинге с результатом 66.08, однако в итоговой аналитической оценке была поднята на второе место.

Основная причина — более сбалансированный профиль площадки. OKX сочетает высокий торговый объем, широкий набор инструментов и развитое направление деривативов. Дополнительным преимуществом является прозрачность резервов: биржа регулярно публикует Proof of Reserves, что позволяет отдельно оценивать обеспечение пользовательских активов.
